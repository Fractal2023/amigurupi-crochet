...
export const Telefono = (p: Props) => (
  <Base {...p}>
    <path d="M7.7 3.6h-2A2.2 2.2 0 0 0 3.5 6c.5 7.6 6.9 14 14.5 14.5a2.2 2.2 0 0 0 2.4-2.2v-2a1.5 1.5 0 0 0-1.2-1.47l-2.6-.52a1.5 1.5 0 0 0-1.6.76l-.7 1.3a12.6 12.6 0 0 1-5.2-5.2l1.3-.7a1.5 1.5 0 0 0 .76-1.6l-.52-2.6A1.5 1.5 0 0 0 7.7 3.6Z" />
  </Base>
);
